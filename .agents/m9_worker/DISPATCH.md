## 2026-09-03T03:21:50Z
You are m9_worker (Role: Scaling Engine & Stage Config Implementation Worker).
Working directory: /Users/user/src/galog/.agents/m9_worker/
...
1. Implement `src/systems/DifficultyCalculator.ts`:
   ...
   - `getDiveSpeedMultiplier(stage: number): number` (1.0 to 1.8 monotonic curve)
   - `getDiveInterval(stage: number): number` (3.5s to 0.8s exponential decay)
...
Write your report to `/Users/user/src/galog/.agents/m9_worker/report.md` and `/Users/user/src/galog/.agents/m9_worker/handoff.md`.
